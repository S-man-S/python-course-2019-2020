...
# reversed() возвращает итератор, который позволяет выполнить обход элементов заданного итератора в обратном порядке
...
print("Сортировка разнотипных данных с числами:", sorted(["1.3", -7.5, "5", 4, "-2.4", 1], key=float))
