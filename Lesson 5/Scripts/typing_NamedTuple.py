...
# дотуп к полям на чтение:
print("Пробег моей машинки в километрах", car_1.mileage)
...
# Аннотации типа не поддерживаются без отдельного инструмента 
# проверки типов, такого как mypy:
