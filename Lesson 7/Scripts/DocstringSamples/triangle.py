''' Functions of area, perimeter and semiperimeter calculation for triangle.
    Call area(), perimeter(), semiperimeter() and area_heron() functions
'''
...
def area(base, height):
    ...
    Return the area of a right triangle with given base and height
...
def hypotenuse(leg1, leg2):
    ...
    Return the length of hypotenuse of a right triangle based on its leg lengths
    Precondition: legs must be positive, otherwise -> 0
